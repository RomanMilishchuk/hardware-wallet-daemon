...
echo "import distp12"
security import $GOPATH/src/github.com/SkycoinProject/hardware-wallet-daemon/ci-scripts/certs/pkg-dist.p12 -k $KEY_CHAIN -P $CERT_PWD  -A /usr/bin/productsign
